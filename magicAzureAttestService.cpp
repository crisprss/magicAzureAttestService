...
DWORD WINAPI TriggerNamedPipeConnectionThread(LPVOID lpParam)
{
	...
	RpcTryExcept
	{
		...
		status = Proc0(BindingHandle, pwszFileName, &p, num1, &pwszFileName, &num1);
